        ...
        if (outputDir != null) {
            try {
                ...
                if (output != null) {
                    ...
                    finalOutput.close();
                       Toast.makeText(getApplicationContext(), getResources().getString(R.string.file_saved), Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(getApplicationContext(), getResources().getString(R.string.file_saving_error), Toast.LENGTH_LONG).show();
                }
            } catch (Exception e) {
                Toast.makeText(this,
